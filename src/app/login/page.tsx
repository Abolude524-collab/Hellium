      ...
      <div className="w-full max-w-md space-y-8 relative z-10">
        ...
        <div className="text-center space-y-3">
          ...
          <h1 className="font-montserrat text-3xl font-extrabold tracking-tight text-white">
            Welcome Back to Hellium
          </h1>
          <p className="text-sm text-gray-400">
            Log in to manage your multi-currency budgets and expense analytics.
          </p>
        </div>
        ...
        <div className="bg-space-900 border border-space-800 rounded-2xl p-8 shadow-2xl backdrop-blur-xl">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="space-y-1.5">
              ...
              <div className="relative">
                ...
                <input
                  ...
                  placeholder="••••••••"
                  className="w-full pl-10 pr-10 py-3 rounded-xl bg-space-950 border border-space-800 text-sm text-gray-100 placeholder-gray-500 focus:outline-none focus:border-purple-500 focus:ring-1 focus:ring-purple-500 transition-colors"
                />
                <button
                  type="button"
            ...
            <button
              type="submit"
              disabled={isSubmitting}
              className="w-full py-3.5 px-4 mt-2 rounded-xl bg-purple-600 hover:bg-purple-500 text-white font-montserrat font-semibold text-sm shadow-purple-glow transition-all active:scale-[0.98] flex items-center justify-center space-x-2 disabled:opacity-50"
            >
